...
> 这里是我在机器学习 / 深度学习方向上的学习笔记与专题文章。每一篇都力求把复杂的概念讲清楚——数学推导和直觉理解并重。
>
> 所有文章均开源在 [GitHub](https://github.com/liuwwei3/liuwwei3.github.io)，欢迎 clone 后用 AI Agent 辅助阅读（见下文）。
...
<div class="tip-box">
  <strong>高效阅读建议</strong><br>
  如果你是第一次接触机器学习：先读<em>数学快速入门</em>（约 1.6 万字）建立数学直觉，再根据兴趣跳读其他专题。每篇文章约 0.3–3.6 万字，建议分 2–3 次读完，每次配合 AI 问答消化 2–3 个小节。
</div>
...
在职 AI 算法工程师，这个博客是我"把论文读薄"的地方。每一篇文章都经过反复打磨——尽量让数学有直觉、让代码有解释、让架构有图。

有问题或建议欢迎提 [GitHub Issue](https://github.com/liuwwei3/liuwwei3.github.io/issues)。
